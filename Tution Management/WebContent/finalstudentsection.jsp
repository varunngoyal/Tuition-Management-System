...
%>
		...
		<form action ="Logout">
                    ...
                    <button class="button" type="submit">Logout</button>
                     ...
                     <main>
                     <div class="innertube">
                      <iframe src=" " height="1000px" width="100%"  name = "iframe_a"></iframe>
		...
		<nav id="nav"><!DOCTYPE html>
			<div class="innertube">
				<h3>STUDENT SECTION</h3>
                                         ...
                                         <li class="nav-item">
                                         <a class="nav-link" href="finalstudentprofile.jsp" target ="iframe_a">View Profile</a>
                                         </li>
                                         <li class="nav-item">
                                         <a class="nav-link" href="upload.jsp" target ="iframe_a">Upload Profile Photo</a>
                                         </li>
                                         <li class="nav-item">
                                        <a class="nav-link" href="student_timetable.jsp"  target ="iframe_a">View Timetable</a>
                                         </li>
                                         <li class="nav-item">
                                        <a class="nav-link" href="testschedule.jsp"  target ="iframe_a">Test Timetable</a>
                                         </li>
                                         <li class="nav-item">
                                        <a class="nav-link" href="testresult.jsp"  target ="iframe_a">Test Result</a>
                                         </li>
                                         <li class="nav-item">
