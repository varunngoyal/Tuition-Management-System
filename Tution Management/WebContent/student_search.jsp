...
<div class="col-sm-8"> 
	<input name="roll_no" class="form-control" type="number" id="rn" placeholder="Roll No." required> 
</div>
</div>
</div>
...
<div class="col-sm-10"> 
<input name="ln" id="ln" class="form-control" placeholder="Last Name" required> 
</div>
</div>
</div>
...
function result_table() {
	...
	$.ajax ({
		type: "POST",
		url: "student_search_results.jsp",
