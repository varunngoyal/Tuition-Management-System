...
%>
 <%  
  ...
  ResultSet resultset = statement.executeQuery("select  test_id ,date,time,max_score,score , subject_name from test natural join test_results natural join subject where student_id = '" + uname + "'") ;
   
  if(!resultset.next()  ) {
	  {%>
		<script>
		swal("Results are not available");
		</script>
	<%} 
