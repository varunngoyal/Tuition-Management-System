...
%>
		<header id="header">
		<!-- <center><h4 style = "color:white">WELCOME TO FACULTY LOGIN!!!<h4><center>-->
		<form action ="Logout">
                    <p align = "right">
                    <button  class="button" type="submit">Logout</button>
                     ...
                     <main>
                     <div class="innertube">
                      <iframe src=" " height="900px" width="100%"  name = "iframe_a"></iframe>
                     </main>
	

		<nav id="nav"><!DOCTYPE html>
			<div class="innertube">
				<h3>Faculty Section</h3><br>
				
                                         <ul class="nav flex-column">
                                         <li class="nav-item">
                                         <a class="nav-link" href="facultyprofile.jsp" target ="iframe_a">View Profile</a>
                                         </li>
                                         <li class="nav-item">
                                         <a class="nav-link" href= "uploadfac.jsp" target ="iframe_a">Upload Profile Photo</a>
                                         </li>
                                         <li class="nav-item">
                                        <a class="nav-link" href="faculty_timetable_day.jsp"  target ="iframe_a">View Timetable</a>
                                         </li>
                                         
                                          <li class="nav-item">
                                        <a class="nav-link" href="testschedulef.jsp"  target ="iframe_a">Test Schedule</a>
                                         </li>
                                         
                                           <li class="nav-item">
                                        <a class="nav-link" href="searchtest.jsp"    target ="iframe_a"> Add Test Score</a>
                                         </li>
                                           <li class="nav-item">
