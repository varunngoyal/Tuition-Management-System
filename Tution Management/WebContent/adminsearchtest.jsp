...
%>
 <%  
  ...
  ResultSet resultset = statement.executeQuery(" select test_id ,class , course_name ,batch_name,subject_name,date,time,max_score from test natural join batch natural join subject  natural join  course order by date desc");
...
%>
     ...
     <table class="table table-striped""  style= "margin: 30px 20px 0px 20px;">
		...
		<tr>
			...
			<th>Test date</th><th>Test time</th><th>Maximum Marks</th><th>Report</th>	
		</tr>
   ...
   %>
		...
		<td><a href = "testreport.jsp?id=<%=test_id%>">view Report</a></td>
		</tr>
