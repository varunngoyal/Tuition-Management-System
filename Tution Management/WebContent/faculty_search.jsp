...
<div class="form-group">
<label class="control-label col-sm-2" for="rn"> FACULTY ID:</label>
<div class="col-sm-8"> 
<input name="fac_id" min="20001" type="number" class="form-control" id="fac_id" placeholder="Faculty ID" required> 
</div>
</div>
</div>
...
<div class="col-sm-8"> 
<input name="fn" id="fn" class="form-control" placeholder="First Name" required> 
</div>
</div>
</div>
...
<div class="col-sm-8"> 
<input name="ln" id="ln" placeholder="Last Name" class="form-control" required> 
</div>
</div>
</div>
...
<div class="col-sm-10"> 
<select name="subject" class="form-control" id="subject_id" style="width: 178px;">  
...
function result_table() {
	...
	$.ajax ({
		type: "POST",
		url: "faculty_search_results.jsp",
