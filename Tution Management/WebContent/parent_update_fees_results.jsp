...
<%!
	...
	float total_fees, fees_paid, fees_due,rem_fees;
...
if(session.getAttribute("uname")==null)
{
	...
	rem_fees = Float.parseFloat(request.getParameter("rem_fees"));
	fees_due = rem_fees - fees_paid;  
	...
	try {
		...
		s.executeUpdate("UPDATE fees SET "+
		"fees_due = "+fees_due+
		",date_of_payment = '"+date_of_payment+
		"',payment_mode = '"+mode_of_payment+"' WHERE receipt_no = "+receipt_no+";");
...
%>
<script>
swal("Fees installment paid!", "Fees paid successfully!", "success");
</script>
</body>
</html>
